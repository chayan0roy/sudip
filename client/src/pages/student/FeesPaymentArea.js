...
export default function FeesPaymentArea() {
	...
	const getStudentFeesPaymentDetails = async () => {
		...
		if (token) {
			...
			const result = await axios.post("https://student.chayan.online/getStudentFeesPaymentDetails", formData,);
	...
	const submitImage = async (e) => {
		...
		const result = await axios.post("https://student.chayan.online/uploadFiles", formData);
		setFile();
		setAmount();
